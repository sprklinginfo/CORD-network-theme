		...
		<form id="new-post" name="new-post" method="post" action="<?php the_permalink(); ?>">
			...
			<fieldset class="bbp-form">
				...
				<div>
					...
					<p>
						<label for="bbp_forum_visibility"><?php _e( 'Visibility: Public', 'bbpress' ); ?></label><br />
					</p>

					<p>
						<label for="bbp_forum_parent_id"><?php _e( 'Parent Forum: Working Groups', 'bbpress' ); ?></label><br />
