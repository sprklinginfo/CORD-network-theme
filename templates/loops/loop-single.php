			...
			<div <?php post_class(); ?> id="post-<?php the_ID(); ?>">
				<div class="post-content">
					...
					<div class="social-media-share">
						<p>
							Share This Via: <a href="<?php echo twitter_share_url();?>"><img class="social-share-icons" src="<?php echo get_stylesheet_directory_uri().'/images/twitter-share.png';?>"></a>
							<a href="<?php echo facebook_share_url();?>"><img class="social-share-icons" src="<?php echo get_stylesheet_directory_uri().'/images/facebook-share.png'; ?>"></a>
						</p>
					</div>
					<?php 
